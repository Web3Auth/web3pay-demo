    ...
    <div className="mt-16 flex flex-col gap-y-20">
      <div className="text-center">
        ...
        <p className="text-2xl font-normal text-white w-[80%] mx-auto">
          Here’s what you experienced when leveraging your EOA’s token liquidity
          for cross-chain transactions without gas fees or bridges
        </p>
      </div>
      {(activeStep === STEPS.CONNECT || activeStep === STEPS.VIEW_SUMMARY) && (
